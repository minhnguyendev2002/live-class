  ...
  return (
    <>
      ...
      <div className="absolute bottom-10 left-0 w-full z-10">
        <div className="flex items-end sm:items-center justify-between gap-5 px-3 sm:pl-24">
          <div className="group hidden">
          ...
          {/* <div
            className="lg:hidden cursor-pointer rounded-full flex flex-col items-center justify-center px-3 h-[40px] text-center bg-white duration-300 hover:bg-white/70"
            onClick={showComment}
          >
            Xem bình luận
          </div> */}
